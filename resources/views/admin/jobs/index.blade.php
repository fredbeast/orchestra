...
@section('content')
    <div class="container my-5">
        ...
        <div class="row">
            @foreach ($jobs as $job)
                <div onclick="location.href='{{ action('JobsController@show', $job -> id)  }}';"
                     class="col-8 offset-2 col-sm-5 offset-sm-1 col-md-3 offset-md-0 my-4">
        ...
        <a class="btn btn-primary btn-outline-primary my-5" href="{{ action('JobsController@create')}}">New Job?</a>
